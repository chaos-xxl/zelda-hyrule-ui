...
> 选题标准（3 条全满足）：**① 载体本身欢迎个性化视觉**（自娱 / 收藏 / 社交炫耀 / 粉丝同好 / 装饰个人空间）——严肃对外交付场景（简历 / 商务文档 / 正式报告）一律排除，那里塞尔达皮是减分项；**② BOTW 语义能自然映射**（非硬套皮）；**③ 自带发帖传播点**。都走"路径丙"配方：单文件、零依赖、无构建、真素材、localStorage、中英双语。每个 = 一条发帖素材 + 一个 skill 活样板。
